...
## Project Structure
    ...
    ├── offline_learning_29658  # Django project configurations
...
1. Clone this repo and `cd offline_learning_29658`
...
2. Clone this repo and `cd offline_learning_29658`
